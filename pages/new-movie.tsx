    ...
    <div className=' w-1/2'>
        ...
        <div className=' mt-14 flex flex-row justify-between '>
            ...
            <div className=' flex flex-col items-center gap-y-4'>
                <div>
                  <input type="text" placeholder='Title' className=' rounded-md p-2 text-white outline-none  bg-gray-500 bg-opacity-20' />
                </div>
                <div>
                    <input type="text" placeholder='Publishing year' className=' rounded-md p-2 text-white outline-none  bg-gray-500 bg-opacity-20' />
                </div>
                <div className='flex flex-row gap-2 '>
                   <Secondary name='Cancel' style='' />
                    <Primary name='Submit' style='' />
                </div>
            </div>
        </div>
